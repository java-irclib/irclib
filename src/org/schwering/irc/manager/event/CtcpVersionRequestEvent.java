 ...
 * @since 2.00
 * @version 1.00
 * @see CtcpListener#versionRequestReceived(CtcpVersionRequestEvent)
 */
public class CtcpVersionRequestEvent {
	...
	public CtcpVersionRequestEvent(Connection connection, User sender, User destUser,
	...
	public CtcpVersionRequestEvent(Connection connection, User sender,
