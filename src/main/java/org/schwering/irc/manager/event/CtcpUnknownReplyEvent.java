...
/**
 * Fired when an unknown CTCP reply has been received.
 * @author Christoph Schwering &lt;schwering@gmail.com&gt;
 * @since 2.00
 * @version 1.00
 * @see CtcpListener#unknownReplyEventReceived(CtcpUnknownReplyEvent)
 */
public class CtcpUnknownReplyEvent {
	...
	public CtcpUnknownReplyEvent(Connection connection, User sender, 
